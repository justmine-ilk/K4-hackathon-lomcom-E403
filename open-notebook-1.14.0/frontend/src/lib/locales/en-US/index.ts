export const enUS = {
  ...
  notebooks: {
    ...
    deleteNotebookExclusiveSources: "{{count}} source(s) exist only in this class.",
    deleteNotebookSharedSources: "{{count}} source(s) are shared with other classes and will be unlinked.",
    ...
    activeNotebooks: "Active Classes",
    archivedNotebooks: "Archived Classes",
    tileView: "Tile view",
    listView: "List view",
  ...
  sources: {
    ...
    sourceRemovedFromNotebook: "Source removed from classs successfully",
    failedToRemoveSourceFromNotebook: "Failed to remove source from class",
    removeConfirm: "Are you sure you want to remove this from the class?",
    checking: "Checking...",
    ...
    removeFromNotebook: "Remove from Class",
  ...
  chat: {
    ...
    chatWithNotebook: "Chat with Vlearn Tutor",
