      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="flex flex-wrap items-center gap-4 p-4 rounded-lg border bg-card/50">
          <div className="flex items-center gap-2">
            ...
            <Select value={selectedCourse} onValueChange={setSelectedCourse}>
              ...
              <SelectContent>
                ...
                <SelectItem value="k1">Khóa K1 (2024-2025)</SelectItem>
                <SelectItem value="k2">Khóa K2 (2025-2026)</SelectItem>
                <SelectItem value="k3">Khóa K3 (2026-2027)</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium">Lớp / Môn học:</span>
            <Select value={selectedClass} onValueChange={setSelectedClass}>
              ...
              <SelectContent>
                ...
                <SelectItem value="web">Lớp Lập trình Web</SelectItem>
                <SelectItem value="ai">Lớp Trí tuệ Nhân tạo (AI)</SelectItem>
                <SelectItem value="data">Lớp Khoa học Dữ liệu</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
